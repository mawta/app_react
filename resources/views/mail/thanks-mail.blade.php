    ...
    <tr style="vertical-align: top;" valign="top">
        <td style="word-break: break-word; vertical-align: top;" valign="top">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td align="center" style="background-color:#F5F5F5"><![endif]-->
                ...
                <div class="block-grid two-up no-stack"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#FFFFFF;">
                        ...
                        <td align="center" width="325"
                            style="background-color:#FFFFFF;width:325px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;"
                            valign="top">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                ...
                                <div
                                    ...
                                    <div align="left" class="img-container left fixedwidth"
                                        ...
                                        <![endif]--><img alt="Image" border="0" class="left fixedwidth"
                                                         src="{{$url}}/images/logo_colored.png"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#D6E7F0;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0"
                            ...
                            <tr>
                                <td align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width:650px">
                                        <tr class="layout-full-width" style="background-color:#D6E7F0"><![endif]-->
                        <!--[if (mso)|(IE)]>
                        <td align="center" width="650"
                            style="background-color:#D6E7F0;width:650px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;"
                            valign="top">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                ...
                                <div
                                    ...
                                    <div align="center" class="img-container center fixedwidth"
                                        ...
                                        <img align="center" alt="Image" border="0" class="center fixedwidth"
                                             src="{{$url}}/images/illo_welcome_1.png"
                                             style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 540px; display: block;"
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="padding-right: 10px; padding-left: 15px; padding-top: 20px; padding-bottom: 0px; font-family: Tahoma, Verdana, sans-serif">
                                    <![endif]-->
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 14px; line-height: 75px; text-align: center; margin: 0;">
                                                <span style="font-size: 50px;"><strong><span
                                                            style="line-height: 75px; font-size: 50px;"><span
                                                                style="font-size: 38px; line-height: 57px;">Hello</span></span></strong></span>
                                            </p>
                                            <p style="font-size: 14px; line-height: 51px; text-align: center; margin: 0;">
                                                <span style="font-size: 34px;"><strong><span
                                                            style="line-height: 51px; font-size: 34px;"><span
                                                                style="color: #2190e3; line-height: 51px; font-size: 34px;">{!! $user->name!!}</span></span></strong></span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                        ...
                                        <div
                                            ...
                                            <br/>
                                                <span style="font-size: 18px; color: #000000;">
                                                    Thank you so much for contact with us. We've loved getting to receive your message.
We're so happy that you've stuck around with us for this long.
We always answer in a couple of hours
                                ...
                                {{--<div--}}
                                                        ...
                                                        {{--<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 8px; padding-left: 8px;"--}}
                                                            {{--valign="top"><a href="https://www.facebook.com/"--}}
                                                                            {{--target="_blank"><img alt="Facebook"--}}
                                                                                                 {{--height="32"--}}
                                                                                                 {{--src="{{$url}}/images/facebook@2x.png"--}}
                                                        ...
                                                        {{--<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 8px; padding-left: 8px;"--}}
                                                            {{--valign="top"><a href="https://instagram.com/"--}}
                                                                            {{--target="_blank"><img alt="Instagram"--}}
                                                                                                 {{--height="32"--}}
                                                                                                 {{--src="{{$url}}/images/instagram@2x.png"--}}
                                                                                                 {{--style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"--}}
                                                                                                 {{--title="Instagram"--}}
                                                                                                 {{--width="32"/></a></td>--}}
                                                        {{--<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 8px; padding-left: 8px;"--}}
                                                            {{--valign="top"><a href="https://www.pinterest.com/"--}}
                                                                            {{--target="_blank"><img alt="Pinterest"--}}
                                                                                                 {{--height="32"--}}
                                                                                                 {{--src="{{$url}}/images/pinterest@2x.png"--}}
                                                                                                 {{--style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"--}}
                                                                                                 {{--title="Pinterest"--}}
                                                                                                 {{--width="32"/></a></td>--}}
                                                    {{--</tr>--}}
                                    ...
                                    {{--<div--}}
                                        ...
                                        {{--<div--}}
                                            ...
                                            {{--<p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0;">--}}
                                                {{--NetShop - Lorem ipsum dolor sit amet hasellus sagittis aliquam--}}
                                                {{--luctus. </p>--}}
                                            {{--<p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0;">--}}
                                                {{--329 California St, San Francisco, CA 94118</p>--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                                    {{--<!--[if mso]></td></tr></table><![endif]-->--}}
                                    {{--<table border="0" cellpadding="0" cellspacing="0" class="divider"--}}
                                        ...
                                        {{--<div--}}
                                            ...
                                            {{--<p style="font-size: 12px; line-height: 16px; text-align: center; margin: 0;">--}}
                                                {{--<span style="font-size: 14px;"><a href="#" rel="noopener"--}}
                                                                                  ...
                                                                                  {{--target="_blank"><strong>Help&amp; FAQ's</strong></a> |  <strong><a--}}
                                                            {{--href="#" rel="noopener"--}}
                                                            {{--style="text-decoration: none; color: #2190E3;"--}}
                                                            {{--target="_blank">Returns</a> </strong> |  <span--}}
                                                        {{--style="background-color: transparent; line-height: 16px; font-size: 14px;">1-998-9283-19832</span></span>--}}
                                            {{--</p>--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                                    {{--<!--[if mso]></td></tr></table><![endif]-->--}}
